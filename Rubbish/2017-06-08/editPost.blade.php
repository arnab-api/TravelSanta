...
@section('content')
    <div class="col-md-9 main">
        ...
        <div>
            ...
            <textarea name="placeDes" class="placeDescription" value = {{$review}}></textarea>

            <h5 class="placeFont">Images :</h5>
            <div class="ChooseImage">
                {!! Form::file('img[]', array('multiple'=>true)) !!}
                <h class="CoverImageFont"> * 1st one will be post cover </h>
            </div>
            ...
            <h5 class="placeFont">Rating (on 5):</h5>
